...
globalThis.Input = (() => {
    ...
    function pollInput() {
        ...
        // Foreground: cap to avoid giant catch-up after hitches.
        // Background: fixed step so hidden-time does not turn into big burst dt.
        const dt = hidden ? 0.05 : Math.min(rawDt, 0.1);
        lastTime = now;
